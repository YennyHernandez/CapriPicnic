...
class PicnicViewDetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val picnicViewDetails = args.picnicViewSelected
        Picasso.get().load(picnicViewDetails.photos[0].url).into(binding.picnicDetailsImageView)
        binding.nombreTextView.text = picnicViewDetails.description
        binding.nameTextView.text = picnicViewDetails.name
