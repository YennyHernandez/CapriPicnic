...
class ProductViewDetailsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Picasso.get().load(productDetails.photos[0].url).into(binding.productViewImageView)
        binding.productViewDescriptionTextView.text = productDetails.description
        binding.productViewNameTextView.text = productDetails.name
